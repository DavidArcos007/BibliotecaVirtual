...
class BusquedasActivity : AppCompatActivity() {
    ...
    private val BASE_URL = "https://cuevana3.io/"
    private val BASE_URL_BUSQUEDA ="https://google.com/"
    ...
    private fun Navegacion()
    {
        ...
        svNavegacion.setOnQueryTextListener(object:SearchView.OnQueryTextListener{
            ...
            override fun onQueryTextSubmit(cadena: String?): Boolean {
                cadena?.let{
                    ...
                    {
                        //Si la url es valida entra aqui
                        wvNavegacion.loadUrl(it)
                    }
                    else
                    {
                        wvNavegacion.loadUrl(BASE_URL_BUSQUEDA+SEARCH_PATH+it)
                    }
                }
                return false
            }
        ...
        {
            //La aplicacion controla la carga de las url
